	...
	public class ProfileUI extends View {
		...
		protected static var uiXML:XML =
			<View width="800" height="480">
			  ...
			  <Label text="85后" x="90" y="428" autoSize="left" background="false" width="58" height="26" skin="png.comp.label_tag" align="center" sizeGrid="1,1,24,4" color="0xffffff" bold="false" size="14" font="Arial" letterSpacing="1" margin="1,3,9,1"/>
			  ...
			  <Label text="微博" x="42" y="281" bold="true" color="0x333333" width="37" height="20"/>
			  <Label text="邮件" x="41" y="317" bold="true" color="0x333333" width="34" height="22"/>
			  <LinkButton label="ihowe@outlook.com" x="112" y="315" var="m_emailBtn" labelSize="14" buttonMode="true"/>
			  <Label text="微信" x="40" y="349" bold="true" color="0x333333" width="35" height="21"/>
			  <Label text="一个游戏前端程序员，目前就职于上海墨白科技" x="40" y="238" bold="true" color="0x333333" width="419" height="20" size="15"/>
			  <Label text="howe_wh" x="113" y="281" width="68" height="20" color="0x333333" buttonMode="true" var="m_weiboLabel" backgroundColor="0x333333" size="14" mouseChildren="false"/>
			  <Image skin="png.comp.img_v" x="172" y="282"/>
			  <LinkButton label="howe_wh" x="112" y="349" var="m_wxBtn" labelSize="14" buttonMode="true"/>
